...
main: BEGIN
  ...
  /* ===== 8. Determinar cita más temprana ===== */
  ...
  IF v_estado = 'pendiente' THEN
    UPDATE notificaciones
     ...
     WHERE id_entidad_destino = v_id_paciente
       ...
       AND estado = 'pendiente'
       AND (id_entidad_desencadenadora IS NULL OR id_entidad_desencadenadora <> NEW.id_cita);
  END IF;

  /* ===== 11. Upsert notificación ===== */
  IF EXISTS (
